...
TODO(content-move): the generated-code import instructions below reference
`marlib.adapters.mas_zero.core`, which no longer exists after externalisation.
When reviving mas_zero, alias the package to a stable import path and update
these strings (see blocks.py).
"""
...
IMPORTANT: Always import from marlib.adapters.mas_zero.core:
  `from marlib.adapters.mas_zero.core import Info, LLMAgentBase`
