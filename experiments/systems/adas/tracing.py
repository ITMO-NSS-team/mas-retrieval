"""Tracing models for ADAS generated architectures.

Captures the full lifecycle of an ADAS execution: meta-model generation,
architecture structure, agent interactions, and execution results. Activated
via config ``trace: true`` or environment variable ``ADAS_TRACE=1``.
"""
...
class ADASTrace(BaseModel):
    """Full trace of one ADAS question execution."""
